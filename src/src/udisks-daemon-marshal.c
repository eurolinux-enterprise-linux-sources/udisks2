                                                      ...
                                                      gpointer      marshal_data)
{
  ...
  callback = (GMarshalFunc_BOOLEAN__BOXED_INT_BOXED_BOXED) (marshal_data ? marshal_data : cc->callback);
                                              ...
                                              gpointer      marshal_data)
{
  ...
  callback = (GMarshalFunc_BOOLEAN__BOOLEAN_BOXED) (marshal_data ? marshal_data : cc->callback);
